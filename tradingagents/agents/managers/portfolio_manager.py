...
- **View**: where the stock itself goes, exactly "up", "down" or "flat" (a move under half the stock's own standard deviation over the horizon) "over N trading days", e.g. "up over 20 trading days"; independent of the rating
